    ...
    <div className="outerContainer">
      <div className="pageContainer">
        ...
        <p className="textHeader" id="specialHeaderStart">What is Duguid Construction?</p>
          ...
          <img className="siteGifs" src="https://res.cloudinary.com/dbvgiuj6d/image/upload/v1673819746/Personal%20Site/ezgif.com-gif-maker_ayhfvh.gif"></img>
          ...
          <img className="siteGifs" src="https://res.cloudinary.com/dbvgiuj6d/image/upload/v1673820706/Personal%20Site/ezgif.com-gif-maker_2_sfk2tg.gif"></img>
