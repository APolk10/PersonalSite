  ...
  return (
    <div id="mvp-outer-container">
      <div id="mvp-container">
        ...
        <p id="mvp-paragraph-1">
          This map is an open source TopoJSON map that I heavily modified. All of the color highlighting and events that occur on the page were my own tweaking. I wanted the user to have immediate feedback when they interacted with the map. You can zoom in and out with the mousewheel and all countries highlight on hover. In addition to this when clicking, the map passes an object with the event that contains country codes unique to the country. I then used a country code converting library to help me pass the correct string to my external API. I talk about this more in depth below.
          </p>
        ...
        <p id="mvp-paragraph-1">
          The button on the modal redirects the user in a new window to spotify. I tweak the url so that a search request is made with the Spotify API which will allow the user to land on the page as if they typed in the artist into the search bar.
          </p>
