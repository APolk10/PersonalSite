...
function MVP() {
  ...
  const URLs = [
  'https://res.cloudinary.com/dbvgiuj6d/image/upload/v1668040571/home_avkzzg_powa0p.jpg',
  'https://res.cloudinary.com/dbvgiuj6d/image/upload/v1668040572/highlight_sranqm_f9oncb.jpg',
  'https://res.cloudinary.com/dbvgiuj6d/image/upload/v1668040571/popup_zbdptd_dqksar.jpg',
  'https://res.cloudinary.com/dbvgiuj6d/image/upload/v1668040571/nextSlide_n9xmw4_wbmwv2.jpg',
  'https://res.cloudinary.com/dbvgiuj6d/image/upload/v1668040571/resultOfRedirect_msp8ag_sqlwoy.jpg'
  ]
