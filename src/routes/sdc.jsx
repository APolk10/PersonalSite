  ...
  return (
    <div id="sdc-outer-container">
      <div id="sdc-container">
        ...
        <div id="sdc-steps">Step One: Transfer databases</div>
        ...
        <div id="sdc-steps">Step Two: Rewrite server routes</div>
        <p id="sdc-answers">
        ...
        <div id="sdc-steps">Step Five: Load balancing with Nginx</div>
        ...
        <div id="sdc-paragraphQuestions">Wrapping up the experience:</div>
